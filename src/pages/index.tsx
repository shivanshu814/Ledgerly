...
export default function Home() {
  ...
  return (
    <div className={`${inter.className} min-h-screen bg-black text-white`}>
      ...
      <div className="relative max-w-7xl mt-32 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-7xl sm:text-8xl md:text-9xl font-bold tracking-tight">
            <span className="relative inline-block">
              ...
              <span className="relative text-[#8b5cf6] animate-text-glow">Track Your Expense</span>
            </span>
          </h1>
          <p className="mt-12 text-xl sm:text-2xl text-gray-400 max-w-2xl mx-auto">
            A simple and powerful expense tracker to help you manage your finances better.
          </p>
              ...
              >
                <div className="relative overflow-hidden bg-black backdrop-blur-xl rounded-2xl shadow-xl border border-white/5 p-8 transition-all duration-300 hover:border-white/10 hover:shadow-2xl hover:scale-[1.02]">
                  ...
                  <div className="relative">
                    <span className={`inline-flex items-center justify-center p-4 rounded-xl ${feature.color} shadow-lg ${feature.glowColor}/20`}>
                      {feature.icon}
                    </span>
                    <h3 className={`mt-8 text-xl font-medium tracking-tight ${feature.color}`}>
                      {feature.title}
                    </h3>
      ...
      <style jsx global>{`
        @keyframes text-glow {
          0%, 100% { text-shadow: 0 0 30px #8b5cf6; }
          50% { text-shadow: 0 0 60px #8b5cf6; }
        }
        .animate-text-glow {
